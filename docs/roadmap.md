...
| **C — mobile and parity** | appium-mcp adapter, synthesized `ref=mN` snapshots, `mobile_*` tools, platform overlays, parity matrix, Android CI | `packages/adapter-appium` (new in M6), `.github/workflows/android-e2e.yml` | [ADR-0015](./adr/), [tool catalog](./tool-catalog.md) |
